...
namespace EST.MIT.Invoice.Api.Test
{
    public class PaymentRequestValidatorTest
    {
        ...
        [Fact]
        public async Task Given_InvoiceHeader_When_The_Status_Field_IsNot_PendingApproval_Or_Approved_Before_Invoice_Value_Validation_Then_InvoiceHeader_Fails()
        {
            //Arrange
            PaymentRequest paymentRequest = new PaymentRequest()
            {
            ...
            Assert.True(response.Errors.Count(x => x.ErrorMessage.Contains("Status Field not equal to PendingApproval or Approved")) == 2);
        }
