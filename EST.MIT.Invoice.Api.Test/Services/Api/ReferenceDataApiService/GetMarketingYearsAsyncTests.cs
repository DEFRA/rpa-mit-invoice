...
{
    public class GetMarketingYearsAsyncTests
    {
        ...
        public GetMarketingYearsAsyncTests()
        {
            ...
            _httpContentDeserializerMock.Setup(x => x.DeserializeListAsync<MarketingYear>(It.IsAny<HttpContent>()))
                .ReturnsAsync(new List<MarketingYear>()
                {
                new MarketingYear()
                {
                    Code = "DOM",
        ...
        [Fact]
        public void GetMarketingYearsAsync_Returns_List()
        {
            _mockReferenceDataRepositoryMock.Setup(x => x.GetMarketingYearsListAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
            ...
            var response = service.GetMarketingYearsAsync(_accountType, _organisation, _paymentType, _schemeType).Result;
        ...
        [Fact]
        public void GetMarketingYearsAsync_API_Returns_NoContent()
        {
            _mockReferenceDataRepositoryMock.Setup(x => x.GetMarketingYearsListAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
            .ReturnsAsync(new HttpResponseMessage(HttpStatusCode.OK));
        ...
        [Fact]
        public void GetMarketingYear_Deserialise_Fail()
        {
            _mockReferenceDataRepositoryMock.Setup(x => x.GetMarketingYearsListAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
            .ReturnsAsync(new HttpResponseMessage(HttpStatusCode.OK)
            {
        ...
        [Fact]
        public void GetMarketingYearAsync_API_Returns_NotFound()
        {
            _mockReferenceDataRepositoryMock.Setup(x => x.GetMarketingYearsListAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
        ...
        [Fact]
        public void GetSchemeCodeAsync_API_Returns_BadRequest()
        {
            _mockReferenceDataRepositoryMock.Setup(x => x.GetMarketingYearsListAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
        ...
        [Fact]
        public void GetMarketingYearAsync_API_Returns_Unexpected()
        {
            _mockReferenceDataRepositoryMock.Setup(x => x.GetMarketingYearsListAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
        ...
        [Fact]
        public async Task GetMarketingAsync_ResponseDataTaskIsFaulted_LogsErrorAndHandlesException()
        {
            // Arrange
            ...
            mockRepository
                .Setup(x => x.GetMarketingYearsListAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
                .ReturnsAsync(response);

            var service = new ReferenceDataApi(mockRepository.Object, mockLogger.Object, new FaultedHttpContentDeserializer());

            // Act
            var result = await service.GetMarketingYearsAsync(_accountType, _organisation, _paymentType, _schemeType);
        ...
        [Fact]
        public async Task GetMarketingYearAsync_ResponseDataIsNull_ReturnsNotFound()
        {
            // Arrange
            var mockRepository = new Mock<IReferenceDataRepository>();
            var mockLogger = new Mock<ILogger<ReferenceDataApi>>();
