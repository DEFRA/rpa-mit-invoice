...
namespace EST.MIT.Invoice.Api.Test.Services.Api.ReferenceDataApiService
{
    public class GetFundCodeAsyncTests
    {
        ...
        public GetFundCodeAsyncTests()
        {
            ...
            _httpContentDeserializerMock.Setup(x => x.DeserializeListAsync<FundCode>(It.IsAny<HttpContent>()))
        ...
        public void GetFundCodeAsync_Returns_List()
        {
            ...
            var response = service.GetFundCodesAsync(_accountType, _organisation, _paymentType, _schemeType).Result;
        ...
        public async Task GetFundCodeAsync_ResponseDataTaskIsFaulted_LogsErrorAndHandlesException()
        {
            ...
            // Act
            var result = await service.GetFundCodesAsync(_accountType, _organisation, _paymentType, _schemeType);
