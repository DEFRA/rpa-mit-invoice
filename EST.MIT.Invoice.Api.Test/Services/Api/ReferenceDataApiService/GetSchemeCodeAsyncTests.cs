...
{
    public class GetSchemeCodeAsyncTests
    {
        ...
        public GetSchemeCodeAsyncTests()
        {
        ...
        [Fact]
        public void GetSchemeCodeAsync_Returns_List()
        {
        ...
        [Fact]
        public void GetSchemeCodeAsync_API_Returns_NoContent()
        {
            _mockReferenceDataRepositoryMock.Setup(x => x.GetSchemeCodesListAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
            .ReturnsAsync(new HttpResponseMessage(HttpStatusCode.OK));
        ...
        [Fact]
        public void GetSchemeCodeAsync_Deserialise_Fail()
        {
            _mockReferenceDataRepositoryMock.Setup(x => x.GetSchemeCodesListAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
            .ReturnsAsync(new HttpResponseMessage(HttpStatusCode.OK)
            {
        ...
        [Fact]
        public void GetSchemeCodeAsync_API_Returns_NotFound()
        {
            _mockReferenceDataRepositoryMock.Setup(x => x.GetSchemeCodesListAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
        ...
        [Fact]
        public void GetSchemeCodeAsync_API_Returns_Unexpected()
        {
            _mockReferenceDataRepositoryMock.Setup(x => x.GetSchemeCodesListAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
        ...
        [Fact]
        public async Task GetSchemeCodeAsync_ResponseDataTaskIsFaulted_LogsErrorAndHandlesException()
        {
            // Arrange
            ...
            mockRepository
                .Setup(x => x.GetSchemeCodesListAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
        ...
        [Fact]
        public async Task GetSchemeCodeAsync_ResponseDataIsNull_ReturnsNotFound()
        {
            // Arrange
            var mockRepository = new Mock<IReferenceDataRepository>();
            var mockLogger = new Mock<ILogger<ReferenceDataApi>>();
