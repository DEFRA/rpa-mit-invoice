...
{
    public class GetFundCodesForRouteAsyncTests
    {
        ...
        private readonly List<FundCode> fundCodes;


        public GetFundCodesForRouteAsyncTests()
        {
            ...
            _mockHttpContentDeserializer.DeserializeListAsync<FundCode>(Arg.Any<HttpContent>())
                .Returns(x => Task.FromResult((IEnumerable<FundCode>)fundCodes));

            _mockReferenceDataRepository.GetFundCodesListAsync(Arg.Any<string>(), Arg.Any<string>(), Arg.Any<string>(), Arg.Any<string>())
                .Returns(x => Task.FromResult(new HttpResponseMessage(HttpStatusCode.OK)
                {
                    Content = new StringContent(JsonSerializer.Serialize(fundCodes), Encoding.UTF8, "application/json")
                }));
            _mockCacheService.GetData<IEnumerable<FundCode>?>(Arg.Any<object>())
                .Returns(x => null);
        ...
        [Fact]
        public async Task GetFundCodesForRouteAsync_ReturnsDataFromCache_WhenDataExists()
        {
            // Arrange
            _mockCacheService.GetData<IEnumerable<FundCode>?>(Arg.Any<object>())
                .Returns(x => fundCodes);
            ...
            // Act
            var result = await _service.GetFundCodesForRouteAsync(this._accountType, this._organisation, this._paymentType, this._schemeType);
        ...
        [Fact]
        public async Task GetFundCodesForRouteAsync_ReturnsDataFromApi_WhenNotInCache()
        {
            // Act
            var result = await _service.GetFundCodesForRouteAsync(this._accountType, this._organisation, this._paymentType, this._schemeType);
            ...
            var fundCodesResults = result.Data.ToList();
            fundCodesResults.Should().HaveCount(2);
            fundCodesResults[0].Code.Should().Be("DOM");
            fundCodesResults[0].Description.Should().Be("Domestic");
            fundCodesResults[1].Code.Should().Be("EU");
            fundCodesResults[1].Description.Should().Be("European Union");
        }

        [Fact]
        public async Task GetFundCodesForRouteAsync_API_Returns_NoContent()
        {
            // Arrange
            this._mockReferenceDataRepository.GetFundCodesListAsync(Arg.Any<string>(), Arg.Any<string>(), Arg.Any<string>(), Arg.Any<string>())
                .Returns(x => Task.FromResult(new HttpResponseMessage(HttpStatusCode.OK)));
        ...
        [Fact]
        public async Task GetFundCodesForRouteAsync_Deserialize_Fail()
        {
            // Arrange
            this._mockReferenceDataRepository.GetFundCodesListAsync(Arg.Any<string>(), Arg.Any<string>(), Arg.Any<string>(), Arg.Any<string>())
                .Returns(x => Task.FromResult(new HttpResponseMessage(HttpStatusCode.OK)
        ...
        [Fact]
        public async Task GetFundCodesForRouteAsync_API_Returns_NotFound()
        {
            // Arrange
            this._mockReferenceDataRepository.GetFundCodesListAsync(Arg.Any<string>(), Arg.Any<string>(), Arg.Any<string>(), Arg.Any<string>())
        ...
        [Fact]
        public async Task GetFundCodesForRouteAsync_API_Returns_BadRequest()
        {
            // Arrange
            this._mockReferenceDataRepository.GetFundCodesListAsync(Arg.Any<string>(), Arg.Any<string>(), Arg.Any<string>(), Arg.Any<string>())
        ...
        [Fact]
        public async Task GetFundCodesForRouteAsync_API_Returns_Unexpected()
        {
            // Arrange
            this._mockReferenceDataRepository.GetFundCodesListAsync(Arg.Any<string>(), Arg.Any<string>(), Arg.Any<string>(), Arg.Any<string>())
        ...
        [Fact]
        public async Task GetFundCodesForRouteAsync_ResponseDataTaskIsFaulted_LogsErrorAndHandlesException()
        {
            // Arrange
            ...
            // Act
            var result = await service.GetFundCodesForRouteAsync(this._accountType, this._organisation, this._paymentType, this._schemeType);
        ...
        [Fact]
        public async Task GetFundCodesForRouteAsync_ResponseDataIsNull_ReturnsNotFound()
        {
            // Arrange
            var responseData = new HttpResponseMessage
            {
