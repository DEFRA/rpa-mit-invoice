...
{
    public class ReferenceDataRepository_GetMainAccountListAsync
    {
        ...
        public ReferenceDataRepository_GetMainAccountListAsync()
        {
            _mockHttpMessageHandler = new Mock<HttpMessageHandler>();
        }

        [Fact]
        public void GetMainAccountListAsync_Returns_200()
        {
            ...
            var response = repo.GetMainAccountsListAsync(_invoiceType, _organisation, _paymentType, _schemeType);
        ...
        public void GetMainAccountListAsync_Returns_200_When_InvoiceType_Or_Organisation_Or_SchemeType_Or_PaymentType_Different_Combos(string invoiceType, string organisation, string paymentType, string schemeType)
        {
            _mockHttpMessageHandler.SetupAnyRequest().ReturnsResponse(HttpStatusCode.OK);
            ...
            var response = repo.GetMainAccountsListAsync(invoiceType, organisation, paymentType, schemeType);
