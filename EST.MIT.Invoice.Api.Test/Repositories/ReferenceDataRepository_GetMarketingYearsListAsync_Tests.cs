...
{
    public class ReferenceDataRepository_GetMarketingYearsListAsync_Tests
    {
        ...
        public ReferenceDataRepository_GetMarketingYearsListAsync_Tests()
        {
            _mockHttpMessageHandler = new Mock<HttpMessageHandler>();
        }

        [Fact]
        public async Task GetMarketingYearsListAsync_Returns_200()
        {
            ...
            var response = await repo.GetMarketingYearsListAsync(_accountType, _organisation, _paymentType, _schemeType);
        ...
        public async Task GetMarketingYearsListAsync_Returns_200_When_AccountType_Or_Organisation_Or_SchemeType_Or_PaymentType_Different_Combos(string accountType, string organisation, string paymentType, string schemeType)
        {
            _mockHttpMessageHandler.SetupAnyRequest().ReturnsResponse(HttpStatusCode.OK);
            ...
            var response = await repo.GetMarketingYearsListAsync(accountType, organisation, paymentType, schemeType);
