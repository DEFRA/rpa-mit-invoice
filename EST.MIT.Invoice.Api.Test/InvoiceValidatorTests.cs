...
public class InvoiceValidatorTests
{
    ...
    [InlineData("not bps")]
    [InlineData("12345")]
    public async Task Given_Invoice_When_SchemeType_Is_Invalid_Then_Invoice_Fails(string? schemeType)
    {
        //Arrange
        Invoice invoice = new Invoice()
        {
    ...
    [InlineData("NOT EU")]
    [InlineData("12345")]
    public async Task Given_Invoice_When_PaymentType_Is_Invalid_Then_Invoice_Fails(string? paymentType)
    {
        //Arrange
        Invoice invoice = new Invoice()
        {
